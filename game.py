import time
from theory import HumanPlayer, RandomComputerPlayer, GeniusComputerPlayer
...
class TicTacToe:
    ...
    def available_moves(self):
        ...
        #     if spot == ' ':
        #         moves.append(i)
        # return moves  ### ctrl k then ctrl c
    ...
    def winner(self, square, letter):
        ...
        # these are the only moves to win the diagonal
        if square % 2 == 0:
...
if __name__ == '__main__':
    ...
    print(
        f'After 1000 iterations, {x_wins} X wins, {o_wins} O wins and {ties} ties.')


# FOR HUMAN TO PLAY AND TEST
# if __name__ == '__main__':
...
# BEST COMPUTER VS BEST COMPUTER
# if __name__ == '__main__':
#     x_player = GeniusComputerPlayer('X')
#     o_player = GeniusComputerPlayer('O')
#     t = TicTacToe()
